...
const App = (() => {
    ...
    const _ACTIVITY_LABELS = {
        ...
        opaque_login_success:    'Logged in',
        ldap_login_success:      'Logged in',
        oidc_login_success:      'Logged in',
        opaque_login_failed:     'Login failed',
        ldap_login_failed:       'Login failed',
        oidc_login_failed:       'Login failed',
