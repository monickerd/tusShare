-- 002_e1_role_framework.sql — Phase E1: Modular role/permission framework
--
-- Adds role_permission_flags (flag definitions) and role_permissions (flag
-- values per role).  Removes the legacy 3-tier team roles seeded in 001 and
-- inserts the 6-tier default hierarchy.  Seeds all flag defaults per role.
--
...
-------------------------------------------------
-- REMOVE LEGACY TEAM ROLES (seeded in 001_core_schema)
-------------------------------------------------
...
-- role_admin (legacy): same grants as server_admin for backward compat
INSERT INTO role_permissions (role_id, flag, value) VALUES
...
-- team_member and role_user have no flags granted.
